...
var getFactogramCreator = function(fact) {
  var button =    ''
                  ...
                  + '           <option data-img-src="/img/generatesmall/boris2.jpg" value="boris2.jpg">boris2.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/angela1.jpg" value="angela1.jpg">angela1.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/dave.jpg" value="dave.jpg">dave.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/campaign2.jpg" value="campaign2.jpg">campaign2.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/christine1.jpg" value="christine1.jpg">christine1.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/nigel2.jpg" value="nigel2.jpg">nigel2.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/obama.jpg" value="obama.jpg">obama.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/priti.jpg" value="priti.jpg">priti.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/london2.jpg" value="london2.jpg">london2.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/sadiq.jpg" value="sadiq.jpg">sadiq.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/nicola.jpg" value="nicola.jpg">nicola.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/campaign3.jpg" value="campaign3.jpg">campaign3.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/angelae1.jpg" value="angelae1.jpg">angelae1.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/london3.jpg" value="london3.jpg">london3.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/boris3.jpg" value="boris3.jpg">boris3.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/christine.jpg" value="christine.jpg">christine.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/gordon.jpg" value="gordon.jpg">gordon.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/campaign1.jpg" value="campaign1.jpg">campaign1.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/george.jpg" value="george.jpg">george.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/london4.jpg" value="london4.jpg">london4.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/jean.jpg" value="jean.jpg">jean.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/campaign4.jpg" value="campaign4.jpg">campaign4.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/london1.jpg" value="london1.jpg">london1.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/nigel.jpg" value="nigel.jpg">nigel.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/boris4.jpg" value="boris4.jpg">boris4.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/angela2.jpg" value="angela2.jpg">angela2.jpg</option>'
                  + '           <option data-img-src="/img/generatesmall/boris.jpg" value="boris.jpg">boris.jpg</option>'
                  + '         </select>'
                  + '       </div>'
                  + '     </ul>'
                  + '   </div>'
